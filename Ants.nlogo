...
to go  ;; forever button
  ...
  [ set chemical chemical * (100 - evaporation-rate) / 100  ;; slowly evaporate chemical
    recolor-patch ]
  ask patch 1 1 [set plabel "food in nest:"]
  ask patch 1 -1 [set plabel collected-food]

  if collected-food > 10 and ticks mod 10 = 0 and count turtles < 200 and create-ants?[
...
"" ""
PENS
"Pen 1" 1 0 -2805978 true "" "plot count turtles with [color = red]"
"Pen 2" 1 0 -7697782 true "" "plot count turtles with [color = orange + 1]"
"Pen 3" 1 0 -16579837 true "" "plot count turtles"
@#$#@#$#@
## WHAT IS IT?
